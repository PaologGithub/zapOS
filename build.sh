...
# C
gcc -m64 -ffreestanding -c src/kernel/c_helpers/asm_helper.c -o build/output/asm_helper.o
gcc -m64 -ffreestanding -c src/kernel/c_helpers/int_helper.c -o build/output/int_helper.o
